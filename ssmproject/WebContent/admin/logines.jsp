...
<head>
    ...
    <style>
        * {
        ...
        .container {
            height: 100%;
            background-image: linear-gradient(to top, #FAF9DE, #FDE6E0);
        }
        .login-wrapper {
        ...
        .input-item {
            ...
            border: 0;
            padding: 10px;
            border-bottom: 1px solid rgb(250, 249, 222);
            font-size: 15px;
            outline: none;
        }
        ...
        .btn {
            ...
            width: 80%;
            margin-top: 40px;
            background-image: linear-gradient(to right, #FAF9DE, #FDE6E0);
            color: #000000;
        }
        .msg {
            text-align: center;
