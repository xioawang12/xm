	...
	<body onload="jiazai()">
		...
		<div class="head ding">
			<div class="wrapper clearfix">
				<div class="clearfix" id="top">
					<h1 class="fl"><a href="../IndexController/getindex"><img src="../qian/img/logo.png"/></a></h1>
					<div class="fr clearfix" id="top1">
						...
						<div class="btn fl clearfix">
							<a href="mygxin.html"><img src="../qian/img/grzx.png"/></a>
							<a href="#" class="er1"><img src="../qian/img/ewm.png"/></a>
							<a href="cart.html"><img src="../qian/img/gwc.png"/></a>
					...
					<li>
						...
						<div class="sList">
							<div class="wrapper  clearfix">
								<a href="paint.html">
									<dl>
										<dt><img src="../qian/img/nav1.jpg"/></dt>
										<dd>浓情欧式</dd>
									</dl>
								</a>
								<a href="paint.html">
									<dl>
										<dt><img src="../qian/img/nav2.jpg"/></dt>
										<dd>浪漫美式</dd>
									</dl>
								</a>
								<a href="paint.html">
									<dl>
										<dt><img src="../qian/img/nav3.jpg"/></dt>
										<dd>雅致中式</dd>
									</dl>
								</a>
								<a href="paint.html">
									<dl>
										<dt><img src="../qian/img/nav6.jpg"/></dt>
										<dd>简约现代</dd>
									</dl>
								</a>
								<a href="paint.html">
									<dl>
										<dt><img src="../qian/img/nav7.jpg"/></dt>
										<dd>创意装饰</dd>
									</dl>
								</a>
							</div>
		...
		<div class="order mt cart">
			<div class="site">
				<p class="wrapper clearfix">
					...
					<img class="top" src="../qian/img/temp/cartTop03.png">
				</p>
			</div>
			<p class="ok">支付成功！剩余<span>5</span>秒<a href="../MyorderqController/Myorderq?uid="${user.uid}>返回订单页</a></p>
		</div>
		...
		function jiazai() {
			...
			function time(){
				...
				if(seconds==0){
					window.location.href=("../MyorderqController/Myorderq?uid="+uid)
				}
			}
			setInterval(time,1000);
			$.post("../oks/getshoppord",{"uid":${user.uid}},function(res){
				if(res.code=="0"){
					$.post("../oks/updateOrders",{"orderid":res.data[0].orderid},function(res){
					...
					<div class="likeList clearfix">
						<div>
							<a href="proDetail.html">
								<dl>
									<dt><img src="../qian/img/temp/like01.jpg"></dt>
									<dd>【最家】复古文艺风玻璃花瓶</dd>
									<dd>￥193.20</dd>
								</dl>
							</a>
							<a href="proDetail.html">
								<dl>
									<dt><img src="../qian/img/temp/like02.jpg"></dt>
									<dd>【最家】复古文艺风玻璃花瓶</dd>
									<dd>￥193.20</dd>
								</dl>
							</a>
							<a href="proDetail.html">
								<dl>
									<dt><img src="../qian/img/temp/like03.jpg"></dt>
									<dd>【最家】复古文艺风玻璃花瓶</dd>
									<dd>￥193.20</dd>
								</dl>
							</a>
							<a href="proDetail.html">
								<dl>
									<dt><img src="../qian/img/temp/like04.jpg"></dt>
									<dd>【最家】复古文艺风玻璃花瓶</dd>
									<dd>￥193.20</dd>
								</dl>
							</a>
							<a href="proDetail.html" class="last">
								<dl>
									<dt><img src="../qian/img/temp/like05.jpg"></dt>
									<dd>【最家】复古文艺风玻璃花瓶</dd>
									<dd>￥193.20</dd>
								</dl>
							</a>
