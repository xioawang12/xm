...
public class EmailServlet extends HttpServlet {
	...
	private void mGetVCode() {
		// TODO Auto-generated method stub
		if(!isEmail(uemail)) {  // 邮箱不正确
			out.print(-1);
			return;
		}
		try {
			emailUtil.sendEmail(uemail);
		} catch (Exception e) {
